...
function testdeuclient_main()
{
	...
	$cUCli->setConfig( ucli\CUCClient::CONFIG_COOKIE_DOMAIN, '.ladep.cn' );
	$cUCli->setConfig( ucli\CUCClient::CONFIG_COOKIE_SEED, 'sdfdfdcsf380f04/83221234cb-5af5c-1234f-88acd-12348sdsda2sdf' );
